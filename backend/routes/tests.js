            ...
            dbConn.connect().then(async function () {
                ...
                request.query(
                    ...
                    function (err, data) {
                        ...
                        request.query(
                            `SELECT s.student_id, s.wlc_id, s.first_name, s.last_name, s.test_id, s.test_completed, s.advisor, sa.time_submitted, a.is_correct, a.answer_text,q.question_text 
                            FROM students s 
