...
const verifyConnection = async () => {
    try {
        ...
        const result = await fetch(`${import.meta.env.VITE_API_URL}health/db`, {
            method: 'GET',
                        ...
                        <ul class="instruction-list text-body-1">
                            <li>
                                <span class="important">
                                    IMPORTANT: Please read all these instructions before starting
                                    the test!
                                </span>
                            </li>
                            <li>
                                <span class="important">
                                    NO calculators, NO books, NO notes, and NO internet searching
                                    are allowed while taking the test.
                                </span>
                            </li>
                            <li>Once you start the test, you must finish it in one sitting.</li>
                            <li>
                                You’ll be given one question at a time. You cannot go back to a
                                question or change your answer.
                            </li>
                            ...
                            <li>
                                You can only log in once. If you lose your connection, you will have
                                to take the entire exam again.
                            </li>
                            <li>
                                You will need your WLC ID number to log in. Contact the registrar's
                                office (email:
                                <a href="mailto:registrarsoffice@wlc.edu"
                                    >registrarsoffice@wlc.edu</a
                                >
                                or phone: <a href="tel:+14144438785">(414) 443-8785</a>) if you need
                                your number.
                            </li>
                            <li>
                                When you are ready, click <strong>"Begin Test"</strong> to go to the
                                log-in screen.
                            </li>
                        </ul>
